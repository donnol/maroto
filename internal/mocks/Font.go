...
import (
	color "github.com/donnol/maroto/pkg/color"
	consts "github.com/donnol/maroto/pkg/consts"
...
type mockConstructorTestingTNewFont interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFont(t mockConstructorTestingTNewFont) *Font {
	mock := &Font{}
	mock.Mock.Test(t)
